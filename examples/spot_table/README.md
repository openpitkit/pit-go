...
```sh
# Pick a table.
just run-examples-go-table-debug examples/tables/spot/coverage.md
# Run a five-minute soak.
just run-examples-go-table-repeat-debug examples/tables/spot/coverage.md 5m
# Run the tests.
just test-go-debug
```
